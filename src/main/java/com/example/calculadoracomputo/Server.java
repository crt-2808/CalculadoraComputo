...
public class Server extends Application {
    ...
    private String MicroServicio(String pOperacion) throws Exception {
        String result;
        File dir = new File("C:/Users/ramos/Downloads/CalculadoraComputo-6d165417d5807c87581501152d53dfc55414d607/src/main/java/com/example/calculadoracomputo/microservicio.jar");
